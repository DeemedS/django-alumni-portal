            ...
            <li class="splide__slide">
                <div class="alumni-card">
                    <div class="alumni-card-background ${backgroundClass}"></div>
                        ...
                        <img src="${alumnus.profile_image && alumnus.profile_image.trim() !== '' ? alumnus.profile_image : '/static/images/default_user.jpg'}"
     onerror="this.onerror=null;this.src='/static/images/default_user.jpg';"
